    ...
    <view class="item-content">
      ...
      <view class="item-footer">
        <view class="btn-container">
          <button class="handle-btn" @click.stop="$emit('navigateToDetail', item)">办理</button>
          <button v-if="item.freeToOther === '1'" class="delegate-btn" @click.stop="$emit('handleDelegate', item)">委托</button>
