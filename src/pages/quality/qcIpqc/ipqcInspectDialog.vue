      ...
      <scroll-view class="dialog-content" scroll-y>
        ...
        <view class="section" v-if="!loading">
          ...
          <view class="custom-form">
            <view class="form-row" :class="{ 'border-bottom': true }">
              ...
              <view class="form-content">
                <template v-if="mode === 'show'">
                  <text class="view-mode-text">{{ipqcDetail.templateName || '-'}}</text>
                </template>
                <template v-else>
            ...
            <view class="form-row" :class="{ 'border-bottom': true }">
              <view class="form-label">盘重</view>
              <view class="form-content">
                <text class="view-mode-text">{{ipqcDetail.axleLoad || '-'}}</text>
              </view>
            </view>
            <view class="form-row" :class="{ 'border-bottom': true }">
              <view class="form-label">检测重量</view>
              <view class="form-content">
                <text class="view-mode-text">{{ipqcDetail.quantityCheck || '-'}}</text>
              </view>
            </view>
            <view class="form-row" :class="{ 'border-bottom': true }">
              ...
              <view class="form-content">
                <template v-if="mode === 'show'">
                  <text class="view-mode-text">{{ipqcDetail.quantityQualified || '-'}}</text>
                </template>
                <template v-else>
                  <u-input
            ...
            <view class="form-row" :class="{ 'border-bottom': true }">
              ...
              <view class="form-content">
                <text class="view-mode-text">{{ipqcDetail.quantityUnqualified || '-'}}</text>
              </view>
            </view>
            <view class="form-row" :class="{ 'border-bottom': true }">
            ...
            <view class="form-row" :class="{ 'border-bottom': true }">
              ...
              <view class="form-content">
                <template v-if="mode === 'show'">
                  <text class="view-mode-text">{{ipqcDetail.defectName || '-'}}</text>
                </template>
                <template v-else>
                  <u-input
                      v-model="ipqcDetail.defectName"
        ...
        <view class="section" v-if="!loading">
          ...
          <view v-else class="custom-form line-list">
            <view class="form-row border-bottom" v-for="(line, index) in ipqcLineList" :key="line.id || index">
  ...
  methods: {
    ...
    async loadData() {
      ...
      try {
        ...
        await this.loadIpqcDetail()
        await Promise.all([this.loadIpqcLine(), this.getUser()])
      } catch (error) {
    ...
    // 表单基础校验
    validateForm() {
      const { itemCode, itemName, quantityCheck, quantityQualified, templateName } = this.ipqcDetail
    ...
    async handleSave() {
      ...
      try {
        ...
        const res = await updateIpqc(mainData)
