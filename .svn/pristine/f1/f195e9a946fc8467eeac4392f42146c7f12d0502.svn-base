      ...
      <view v-else class="record-list">
        ...
        >
          <view class="record-header">
            <text class="order-number">盘点编号：&nbsp;&nbsp;{{ item.takingCode || '-' }}</text>
            <u-tag
          ...
          <view class="record-content">
            <view class="info-row">
              ...
              <text class="info-value">{{ item.takingName}}</text>
            </view>
            <view class="info-row">
...
import { listStocktaking} from '@/api/wms/stocktaking'
  ...
  methods: {
    ...
    async fetchTableData() {
      ...
      try {
        ...
        const res = await listStocktaking(params)
    ...
    goToSave() {
      uni.navigateTo({
        url: '/pages/wms/stocktaking/save'
      })
    },
